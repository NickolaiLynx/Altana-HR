...
export function ChatWidget() {
  ...
  return (
    <>
      {/* Chat Window */}
      {isOpen && (
        <div ref={chatRef} className="fixed bottom-20 left-4 right-4 md:bottom-24 md:left-auto md:right-6 md:w-[380px] h-[calc(100dvh-160px)] md:h-[500px] max-h-[calc(100dvh-160px)] rounded-2xl shadow-2xl flex flex-col z-[9999] animate-in slide-in-from-bottom-4 duration-300 overflow-hidden">
          {/* Header */}
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-2 md:right-6 w-16 h-16 bg-[#D32F2F] hover:bg-[#B71C1C] text-white rounded-full shadow-lg flex items-center justify-center z-[100] transition-all duration-300 hover:scale-110 animate-chat-pulse"
